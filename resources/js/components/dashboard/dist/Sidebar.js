...
var Sidebar = function (_a) {
    var className = _a.className,
        ...
        handleSidebarIsMobile = _a.handleSidebarIsMobile;
    var _c = react_2.useState(collapsed),
        isCollapsed = _c[0],
        setIsCollapsed = _c[1];
    ...
    var navItems = [
        ...
        {
            name: 'Data Pengguna',
            icon: React.createElement(lucide_react_1.Users2, { size: 20 }),
        ...
        {
            name: 'Training Data Nutrisi',
            icon: React.createElement(lucide_react_1.FolderClockIcon, { size: 20 }),
            href: route('admin.dataset.index'),
            active: 'dataset',
        },
        {
            name: 'Decision Tree',
            icon: React.createElement(lucide_react_1.GalleryHorizontal, { size: 20 }),
            href: route('DecisionTree.index'),
            active: 'decision-tree',
        },
        {
            name: 'Pemeriksaan',
            icon: React.createElement(lucide_react_1.Clock8, { size: 20 }),
            href: route('pemeriksaan.index'),
            active: 'pemeriksaan',
        },
        {
            name: 'Riwayat Pemeriksaan Pengguna',
            icon: React.createElement(lucide_react_1.FolderClockIcon, { size: 20 }),
            href: route('admin.riwayat.index'),
            active: 'riwayat-forest',
        },
    ];
    if (auth.role == 'super_admin') {
        ...
        navItems.push({
            name: 'Jenis Makanan',
            icon: React.createElement(lucide_react_1.LeafyGreen, { size: 20 }),
            href: route('admin.jenisTanaman.index'),
            active: 'jenis-tanaman',
        });
    }
    var isMobile = use_mobile_1.useIsMobile();
    return React.createElement(
        'div',
        { className: utils_1.cn('flex h-full flex-col border-r bg-sidebar transition-all duration-300', isCollapsed ? 'w-16' : 'w-64', className) },
        React.createElement(
            'div',
            ...
            !isMobile
                ? React.createElement(
                      button_1.Button,
                      { variant: 'ghost', size: 'icon', onClick: handleToggleCollapse, className: 'h-8 w-8' },
                      isCollapsed
                ...
                : React.createElement(
                      button_1.Button,
                      { variant: 'ghost', size: 'icon', onClick: handleSidebarIsMobile, className: 'h-8 w-8' },
                        ...
                        navItems.map(function (item) {
                            return React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    {
                                        href: item.href,
                                        className: utils_1.cn('flex items-center', item.active == activeSection ? 'text-primary' : 'text-white'),
                                    },
                                    React.createElement(
                                        tooltip_1.Tooltip,
                                        null,
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                button_1.Button,
                                                {
                                                    ...
                                                    className: utils_1.cn('w-full justify-start', isCollapsed ? 'px-2' : 'px-3'),
                                                },
                                                React.createElement(
                                                    'span',
                                                    ...
                                                    React.createElement(
                                                        'span',
                                                        { className: utils_1.cn(item.active == activeSection ? 'text-primary' : 'text-white') },
                                                        item.icon,
                                                    ),
                                                    !isCollapsed &&
                                                        React.createElement('span', { className: 'ml-3 text-left whitespace-normal' }, item.name),
                                                ),
                                            ),
                                        ),
